...
def check_routing(state: LegalState) -> list[Send]:
    """Conditional edge function: keyword-based routing."""
    print("\n  [Edge: check_routing] Determining specialists via keywords...")
...
QUESTION = "If a company breaks a contract, avoids taxes, and leaks European user data without consent, what are the legal and regulatory consequences?"
